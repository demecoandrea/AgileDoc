...
class FilterSettingsDialog(QDialog):
    ...
    def __init__(self, current_settings, parent=None):
        ...
        self.setStyleSheet(f"background-color: {Colors.HEX_BG_LIGHTER}; color: white; font-family: Segoe UI;")
        ...
        self.lbl_block.setStyleSheet(f"color: {Colors.HEX_SUCCESS}; font-weight: bold;")
        ...
        self.lbl_c.setStyleSheet(f"color: {Colors.HEX_SUCCESS}; font-weight: bold;")
        ...
        btn_close.setStyleSheet(f"background-color: {Colors.HEX_BTN_BG}; padding: 10px; border-radius: 4px;")
